                    ...
                    <button className='ms-auto btn btn-link text-dark' onClick={props.onDismiss}><span className='fa fa-times fa-xs'></span> </button></div>
                        ...
                        <div className='row'>
                         ...
                         <div className='col-md-6 mb-3'>
                            ...
                            <div className='col-md-6 mb-3'>
                                <input type="text" className='form-control borderinput mb-3' placeholder='Amount'/>
                            </div>
                         </div>
                         <div className='row'>
                      
                            <div className='col-md-6 mb-3'>
                                <input type="text" className='form-control borderinput mb-3' placeholder='Purpose'/>
                            </div>
                            <div className='col-md-6 mb-3'>
